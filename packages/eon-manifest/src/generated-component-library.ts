...
export const componentLibrary: ComponentManifestEntry[] = [
  {
    ...
    "examples": [
      {
        "title": "Primary",
        "code": "<eon-button>Save</eon-button>"
      }
    ],
    "antiPatterns": [
    ...
    "related": [],
    "compositionRules": [
      "Compose with Eon layout primitives for consistent spacing."
    ],
    "spec": {
      "visualAnatomy": [
        "container",
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "boolean",
        "default": "false",
        "description": "Shows a visible â€œselect allâ€ action in the toolbar when multiple selection is enabled."
      },
      {
        "name": "showStatus",
        "type": "boolean",
    ...
    "examples": [
      {
        ...
        "code": "<eon-list items=\"Hamburg/Hamburg Suites~20099, An Der Alster 82; Hamburg/The Park Hotel~20537, Borstelmannsweg 82; Honolulu/Honolulu Inn~96801, 822 Mauna Loa Rd\" selection-mode=\"single\" search-enabled></eon-list>"
      }
    ],
    "antiPatterns": [
      "Do not override internal semantics with conflicting roles."
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "boolean",
        "default": "false",
        "description": "Expands the drawer panel to the full viewport width."
      }
    ],
    "events": [],
    "methods": [
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "boolean",
        "default": "false",
        "description": "Uses fixed viewport positioning so the floating panel can escape clipping and sit above the full screen."
      }
    ],
    "events": [
      {
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "boolean",
        "default": "false",
        "description": "Uses fixed viewport positioning so the popover can float above clipping parents and full-screen surfaces."
      }
    ],
    "events": [],
    "methods": [
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "boolean",
        "default": "false",
        "description": "Expands the dialog panel to a full-screen layout inside the viewport."
      },
      {
        "name": "size",
        "type": "\"sm\" | \"md\" | \"lg\"",
    ...
    "examples": [
      {
        ...
        "code": "<eon-progress label=\"Uploading assets\" value=\"65\" show-value-label helper-text=\"3 of 5 files complete.\"></eon-progress>"
      }
    ],
    "antiPatterns": [
      "Do not override internal semantics with conflicting roles."
    ...
    "examples": [
      {
        ...
        "code": "<eon-file-uploader label=\"Attachments\" accept=\".png,.jpg,.pdf\" multiple max-files=\"3\" max-file-size=\"2000000\" help-text=\"Upload up to 3 files, each under 2 MB.\"></eon-file-uploader>"
      }
    ],
    "antiPatterns": [
      "Do not override internal semantics with conflicting roles."
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "boolean",
        "default": "false",
        "description": "Expands the action sheet panel to fill the viewport."
      }
    ],
    "events": [
      {
    ...
    "examples": [
      {
        "title": "Action sheet",
        "code": "<eon-action-sheet open heading=\"Choose action\" items=\"Communication/Call||default|Start a voice call.; Communication/Send message||default|Open the threaded composer.; Review/Request approval||success|Notify approvers.; Danger/Delete draft||danger|This cannot be undone.\"></eon-action-sheet>"
      }
    ],
    "antiPatterns": [
      "Do not override internal semantics with conflicting roles."
    ...
    "examples": [
      {
        ...
        "code": "<eon-color-box label=\"Accent color\" value=\"#f05b41\"></eon-color-box>"
      }
    ],
    "antiPatterns": [
      "Do not override internal semantics with conflicting roles."
    ...
    "examples": [
      {
        ...
        "code": "<eon-load-indicator type=\"ring\" size=\"lg\" layout=\"stacked\" show-label message=\"Syncing data\"></eon-load-indicator>"
      }
    ],
    "antiPatterns": [
      "Do not override internal semantics with conflicting roles."
  ...
  },
  {
    ...
    "props": [
      ...
      },
      {
        ...
        "type": "boolean",
        "default": "false",
        "description": "Renders the overlay against the full viewport instead of only the host content region."
      }
    ],
    "events": [
      {
        "name": "eonVisibilityChange",
    ...
    "examples": [
      {
        ...
        "code": "<eon-load-panel visible heading=\"Loading employee profile\" message=\"Fetching records and recent activity\" description=\"This usually takes a few seconds.\" progress-value=\"72\" show-cancel-button></eon-load-panel>"
      }
    ],
    "antiPatterns": [
      "Do not override internal semantics with conflicting roles."
    ...
    "examples": [
      {
        ...
        "code": "<eon-scroll-view height=\"20rem\"><div>Scrollable content</div></eon-scroll-view>"
      },
      {
        "title": "Scrollable workspace with refresh",
        "code": "<eon-scroll-view height=\"18rem\" show-refresh-button refresh-label=\"Reload feed\"></eon-scroll-view>"
      }
    ],
    "antiPatterns": [
      "Do not override internal semantics with conflicting roles."
    ...
    "examples": [
      {
        ...
        "code": "<eon-tab-panel items=\"Not started,Help needed,In progress,Deferred,Completed\" current=\"2\" tab-position=\"left\"></eon-tab-panel>"
      }
    ],
    "antiPatterns": [
      "Do not override internal semantics with conflicting roles."
    ...
    "examples": [
      {
        ...
        "code": "<eon-splitter position=\"30\"><div slot=\"start\">Navigation</div><div slot=\"end\">Content</div></eon-splitter>"
      }
    ],
    "antiPatterns": [
      "Do not override internal semantics with conflicting roles."
    ...
    "examples": [
      {
        ...
        "code": "<eon-resizable width=\"420\" height=\"260\"><eon-surface>Resizable content</eon-surface></eon-resizable>"
      }
    ],
    "antiPatterns": [
      "Do not override internal semantics with conflicting roles."
