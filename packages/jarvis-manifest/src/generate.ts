...
async function loadSourceRegistries(): Promise<Pick<LibraryManifest, 'components' | 'charts'>> {
  const componentRegistryUrl = pathToFileURL(resolve(currentDir, '../../jarvis-core/src/manifest/registry.ts')).href;
  const chartRegistryUrl = pathToFileURL(resolve(currentDir, '../../mystique-core/src/manifest/registry.ts')).href;
