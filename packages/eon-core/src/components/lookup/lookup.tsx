...
import { filterLabeledOptions, groupOptions, parseLabeledOptions, type LabeledOption, type EonSearchMode } from '../shared/helpers';
...
export class EonLookup {
  ...
  private inputId = createId('eon-lookup');
  private listboxId = createId('eon-lookup-listbox');
  private helpTextId = createId('eon-lookup-help');
  private errorTextId = createId('eon-lookup-error');
