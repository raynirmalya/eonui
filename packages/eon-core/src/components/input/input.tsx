...
export class EonInput {
  ...
  private inputId = createId('eon-input');
  private helpTextId = createId('eon-input-help');
  private errorTextId = createId('eon-input-error');
  private counterId = createId('eon-input-count');
