...
| --------------------- | ----------- | ------------------------------------------------------------------ |
| `eonAttachmentRemove` |             | `CustomEvent<{ name: string; attachments: ChatAttachment[]; }>`    |
| `eonAttachmentToggle` |             | `CustomEvent<{ attachments: ChatAttachment[]; }>`                  |
| `eonSend`             |             | `CustomEvent<{ message: string; attachments: ChatAttachment[]; }>` |
| `eonTypingEnd`        |             | `CustomEvent<void>`                                                |
| `eonTypingStart`      |             | `CustomEvent<void>`                                                |
