...
import { formatNumericValue, type EonNumericFormat } from '../shared/helpers';
...
export class EonRangeSlider {
  ...
  @Prop() valuePrefix = '';
  @Prop() valueSuffix = '';
  @Prop() format: EonNumericFormat = 'decimal';
  @Prop() locale = 'en-US';
  @Prop() currency = 'USD';
  @Prop() unit = '';
  ...
  private inputId = createId('eon-range-slider');
  ...
  private updateStart(nextValue: number) {
    ...
    this.eonChange.emit({ start: this.startValue, end: this.endValue });
  }
