...
export class EonVectorMap {
  ...
  @Event() eonSelect: EventEmitter<{ name: string; value: number }>;
                ...
                <g transform={`translate(${(1 - this.zoom) * 120} ${(1 - this.zoom) * 70}) scale(${this.zoom})`}>
                    ...
                    return [
                      <path
                        ...
                        onClick={() => {
                          ...
                          this.eonSelect.emit({ name: shape.name, value: datum?.value ?? 0 });
                        }}
                      ></path>,
                  ...
                  {this.showMarkers
                    ? this.markerPoints.map((marker) => (
                        <g class="marker" onClick={() => this.eonSelect.emit({ name: marker.label, value: 0 })}>
