...
export class EonSplitter {
  ...
  @Event() eonChange: EventEmitter<{ position: number; collapsed: boolean }>;
  ...
  async toggle(): Promise<void> {
    ...
    this.eonChange.emit({ position: this.position, collapsed: this.collapsed });
  }
