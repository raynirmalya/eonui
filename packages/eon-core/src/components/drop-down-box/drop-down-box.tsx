...
import { buildPathTree, filterLabeledOptions, parseLabeledOptions, parseOptions, type EonSearchMode, type LabeledOption, type PathOptionNode } from '../shared/helpers';
...
export class EonDropDownBox {
  ...
  private inputId = createId('eon-drop-down-box');
  private listboxId = createId('eon-drop-down-box-listbox');
  private labelId = createId('eon-drop-down-box-label');
  private helpTextId = createId('eon-drop-down-box-help');
  private errorTextId = createId('eon-drop-down-box-error');
        ...
        <div class="field" part="base">
          ...
          >
            ...
            <span class="icons">
              ...
              {this.showDropDownButton ? <span class="icon chevron" aria-hidden="true">{renderChevronIcon()}</span> : null}
            </span>
          </button>
