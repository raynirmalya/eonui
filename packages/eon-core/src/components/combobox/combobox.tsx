...
import { filterLabeledOptions, parseLabeledOptions, type LabeledOption, type EonSearchMode } from '../shared/helpers';
...
export class EonCombobox {
  ...
  @Event() eonInput: EventEmitter<{ value: string }>;
  ...
  private listboxId = createId('eon-combobox-listbox');
  private inputId = createId('eon-combobox-input');
  private helpTextId = createId('eon-combobox-help');
  private errorTextId = createId('eon-combobox-error');
  ...
  private emitSelection(nextValue: string, detailValue = nextValue) {
    ...
    this.eonChange.emit({ value: detailValue });
  }
          ...
          <div class="control-wrap">
            <input
              ...
              onInput={(event: Event) => {
                ...
                this.setOpened(true);
                this.activeIndex = -1;
                this.eonInput.emit({ value: this.inputValue });
              }}
