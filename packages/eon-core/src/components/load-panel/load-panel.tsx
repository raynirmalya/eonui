...
import { restoreFocus } from '@eonui/a11y';
...
export class EonLoadPanel {
  ...
  @Prop() coverViewport = false;

  @Event() eonVisibilityChange: EventEmitter<{ visible: boolean }>;
  @Event() eonCancel: EventEmitter<void>;
  ...
  async show(): Promise<void> {
    ...
    this.visible = true;
    this.eonVisibilityChange.emit({ visible: true });
  }

  @Method()
  async hide(): Promise<void> {
    this.visible = false;
    this.eonVisibilityChange.emit({ visible: false });
        ...
        <div class="shell" part="base">
          ...
          >
            ...
            >
              ...
              {showProgress ? <eon-progress value={this.progressValue} label="Progress" showValueLabel part="progress"></eon-progress> : null}
