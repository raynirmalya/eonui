...
export class EonRadio {
  ...
  @Event() eonChange: EventEmitter<{ checked: boolean; value: string }>;
  private fieldId = createId('eon-radio');
  ...
  private onChange = (event: Event) => {
    ...
    this.eonChange.emit({ checked: input.checked, value: this.value });
  };
