...
export class EonTextarea {
  ...
  private textareaId = createId('eon-textarea');
  private helpTextId = createId('eon-textarea-help');
  private errorTextId = createId('eon-textarea-error');
  private counterId = createId('eon-textarea-count');
