...
export class EonScrollView {
  ...
  @Event() eonScroll: EventEmitter<{ top: number; left: number }>;
  @Event() eonReachBottom: EventEmitter<void>;
  @Event() eonReachTop: EventEmitter<void>;
  @Event() eonRefresh: EventEmitter<void>;
  ...
  private onScroll = (): void => {
    ...
    this.eonScroll.emit({ top, left });

    if (top <= this.reachOffset && !this.reachedTop) {
      this.reachedTop = true;
      this.eonReachTop.emit();
    }
