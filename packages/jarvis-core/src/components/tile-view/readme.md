...
| -------------- | ----------- | --------------------------------------------------------------- |
| `jarvisSelect` |             | `CustomEvent<{ value: string; title: string; index: number; }>` |
