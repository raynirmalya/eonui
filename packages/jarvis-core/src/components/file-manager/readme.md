...
| ------------------ | ----------- | -------------------------------------------------------------------------------------------------------------------------- |
| `jarvisAction`     |             | `CustomEvent<{ action: string; path?: string \| undefined; paths?: string[] \| undefined; query?: string \| undefined; }>` |
| `jarvisPathChange` |             | `CustomEvent<{ path: string; }>`                                                                                           |
| `jarvisSelect`     |             | `CustomEvent<{ path: string; kind: string; }>`                                                                             |
