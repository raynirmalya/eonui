...
type JarvisListSelectionMode = JarvisSelectionMode | 'none';
type JarvisSearchMode = 'contains' | 'startsWith' | 'equals';
...
export class JarvisList {
  @Prop() ordered = false;
  @Prop() items = '';
  @Prop() selectionMode: JarvisListSelectionMode = 'none';
  ...
  private toggleOption(option: LabeledOption) {
    ...
    if (this.selectionMode === 'none') {
      this.jarvisChange.emit({ values: [option.value] });
      return;
    }
