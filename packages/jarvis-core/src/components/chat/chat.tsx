...
export class JarvisChat {
  @Prop() label = 'Support conversation';
  @Prop() user = 'John Doe';
  @Prop() status = 'Online now';
  @Prop() statusTone: JarvisTone = 'neutral';
  ...
  @Event() jarvisSend: EventEmitter<{ message: string; attachments: ChatAttachment[] }>;
  @Event() jarvisTypingStart: EventEmitter<void>;
  @Event() jarvisTypingEnd: EventEmitter<void>;
  @Event() jarvisAttachmentToggle: EventEmitter<{ attachments: ChatAttachment[] }>;
  @Event() jarvisAttachmentRemove: EventEmitter<{ name: string; attachments: ChatAttachment[] }>;
  ...
  private toggleAttachment() {
    ...
    this.jarvisAttachmentToggle.emit({ attachments: this.stagedAttachments });
  }
  ...
  private removeStagedAttachment(name: string) {
    ...
    this.jarvisAttachmentRemove.emit({
      name,
