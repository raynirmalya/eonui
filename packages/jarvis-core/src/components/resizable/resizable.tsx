...
export class JarvisResizable {
  ...
  @Event() jarvisResize: EventEmitter<{ width: number; height: number }>;
  ...
  private onPointerMove = (event: PointerEvent): void => {
    ...
    this.jarvisResize.emit({ width: this.currentWidth, height: this.currentHeight });
  };
