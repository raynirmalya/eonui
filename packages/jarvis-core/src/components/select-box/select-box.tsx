...
import { filterLabeledOptions, groupOptions, parseLabeledOptions, type JarvisSearchMode } from '../shared/helpers';
...
export class JarvisSelectBox {
  ...
  private inputId = createId('jarvis-select-box');
  private listboxId = createId('jarvis-select-box-listbox');
  private helpTextId = createId('jarvis-select-box-help');
  private errorTextId = createId('jarvis-select-box-error');
