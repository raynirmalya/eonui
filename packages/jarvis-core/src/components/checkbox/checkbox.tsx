...
export class JarvisCheckbox {
  ...
  @Event() jarvisChange: EventEmitter<{ checked: boolean; indeterminate: boolean }>;
  private input?: HTMLInputElement;
  private fieldId = createId('jarvis-checkbox');
  ...
  private emitChange() {
    this.jarvisChange.emit({ checked: this.checked, indeterminate: this.indeterminate });
  }
