...
import { filterLabeledOptions, groupOptions, parseLabeledOptions, parseOptions, type JarvisSearchMode, type LabeledOption } from '../shared/helpers';

type JarvisApplyValueMode = 'instantly' | 'useButtons';
type JarvisSelectAllMode = 'page' | 'allPages';
...
export class JarvisTagBox {
  ...
  @Prop() selectAllMode: JarvisSelectAllMode = 'page';
  ...
  private inputId = createId('jarvis-tag-box');
  private listboxId = createId('jarvis-tag-box-listbox');
  private helpTextId = createId('jarvis-tag-box-help');
  private errorTextId = createId('jarvis-tag-box-error');
