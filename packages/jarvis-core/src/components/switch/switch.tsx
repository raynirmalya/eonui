...
export class JarvisSwitch {
  ...
  @Event() jarvisChange: EventEmitter<{ checked: boolean }>;
  private fieldId = createId('jarvis-switch');
  ...
  private onChange = (event: Event) => {
    ...
    this.jarvisChange.emit({ checked: this.checked });
  };
